                ...
                let key = match args.button {
                    Button::Keyboard(key) => {
                        match key {
                            ...
                            piston_window::Key::Up    => Some(Key::new(0x2)),
                            piston_window::Key::Down  => Some(Key::new(0x8)),
                            piston_window::Key::Left  => Some(Key::new(0x4)),
                            piston_window::Key::Right => Some(Key::new(0x6)),
                            _ => None,
                        }
                    }
                    _ => None,
